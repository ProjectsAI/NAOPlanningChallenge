...
def main(robotIP, port, legs):
    ...
    distance_x_m=0.05+(0.1*legs)   # 0.12-->4/5steps     0.15-->5/6steps    0.03 -->original
    distance_y_m=-0.02-(0.04*legs) # 0.05-->4/5steps     0.06-->5/6steps    0.012-->original
    print(distance_x_m, distance_y_m)
    theta_deg=0.0
...
if __name__ == "__main__":
    ...
    legs = bool(int(sys.argv[3]))
    print(legs)

    main(robotIP, port, legs)
