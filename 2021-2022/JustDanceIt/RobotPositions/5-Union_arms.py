...
def main(robotIP, port, unit_time):
    ...
    time.sleep((unit_time/2)/6) # Waiting between the two movements
    ...
    RWristYaw = 59.4
    motionProxy.post.angleInterpolation("RWristYaw", RWristYaw * almath.TO_RAD, unit_time/2, True)

    time.sleep(0.2) # For a better movements synchronization
