...
def main(robotIP, port, unit_time):
    ...
    angleLists = [  LShoulderPitch * almath.TO_RAD,
                    ...
                    LWristYaw * almath.TO_RAD,
                    LHand * almath.TO_RAD ]
    motionProxy.setAngles(names, angleLists, 0.2*(1/unit_time)) #0.08
    ...
    angleLists = [  LShoulderPitch * almath.TO_RAD,
                    ...
                    LWristYaw * almath.TO_RAD,
                    LHand * almath.TO_RAD ]
    motionProxy.setAngles(names, angleLists, 0.1*(1/unit_time)) #0.1
    ...
    angleLists = [  RShoulderPitch * almath.TO_RAD,
                    ...
                    RWristYaw * almath.TO_RAD,
                    RHand * almath.TO_RAD ]
    motionProxy.setAngles(names, angleLists, 0.15*(1/unit_time)) #0.15

    time.sleep(unit_time/4) # 0.4
    ...
    angleLists = [  RShoulderPitch * almath.TO_RAD,
                    ...
                    RWristYaw * almath.TO_RAD,
                    RHand * almath.TO_RAD ]
    motionProxy.setAngles(names, angleLists, 0.2*(1/unit_time)) #0.1

    time.sleep(unit_time/12) # 0.2 --> 1/12
    ...
    time.sleep(unit_time/12*11) # 2.2 --> 11/12
